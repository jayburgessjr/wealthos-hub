...
function AccountModal({
  ...
  onClose: () => void;
  userId: string;
  existing: RetirementAccount | null;
}) {
  ...
  return (
    <Dialog open={open} onOpenChange={(v) => !v && onClose()}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          <DialogTitle>
            {existing ? "Edit Account" : "Add Retirement Account"}
          </DialogTitle>
        </DialogHeader>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <Field label="Employer Match (%)">
              <input
                ...
                onChange={set("employer_match_pct")}
                placeholder="0"
              />
            </Field>
          </div>
    ...
    <Card>
      <CardHeader className="pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Independent projection — adjust inputs without affecting your account
          records.
        </p>
      </CardHeader>
          ...
          <>
            <div className="rounded-xl border border-primary/20 bg-primary/5 px-5 py-4">
              ...
              <p className="mt-0.5 text-xs text-muted-foreground">
                Over {parseInt(inputs.targetAge) - parseInt(inputs.currentAge)}{" "}
                years at {inputs.expectedReturnPct}% annual return
              </p>
            </div>
  ...
  return (
    <Card>
      <CardHeader className="pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Find the age where delaying Social Security pays off more than
          claiming early.
        </p>
      </CardHeader>
      <CardContent className="space-y-5">
        <div className="grid grid-cols-3 gap-4">
          <Field label="Monthly Benefit at 62 ($)">
            <input
              ...
              type="number"
              min="0"
              value={inputs.benefit62}
              onChange={set("benefit62")}
            />
          </Field>
          <Field label="Monthly Benefit at 67 ($)">
            <input
              ...
              type="number"
              min="0"
              value={inputs.benefit67}
              onChange={set("benefit67")}
            />
          </Field>
          <Field label="Monthly Benefit at 70 ($)">
            <input
              ...
              type="number"
              min="0"
              value={inputs.benefit70}
              onChange={set("benefit70")}
            />
          </Field>
        </div>
        ...
        <p className="text-xs text-muted-foreground border-t border-border pt-3">
          Break-even assumes no investment return on foregone benefits.
          Longevity, health, and investment returns all factor into the real
          decision.
        </p>
      </CardContent>
    </Card>
...
export default function Retirement() {
  ...
  const kpis = useMemo(() => {
    ...
    const totalAnnualContrib = accounts.reduce(
      (s, a) => s + a.annual_contribution,
      0,
    );
    ...
    const projectedAt65 = accounts.reduce((sum, a) => {
      ...
      const monthlyContrib =
        (a.annual_contribution * (1 + a.employer_match_pct / 100)) / 12;
        ...
        <div className="space-y-6">
          ...
          >
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-0.5">
                Track your retirement accounts, project your nest egg, and
          ...
          >
            <KpiCard
              ...
              value={fmt(kpis.totalBalance)}
              icon={PiggyBank}
            />
            <KpiCard
              label="Annual Contributions"
              value={fmt(kpis.totalAnnualContrib)}
              sub="employee contributions"
            />
            <KpiCard
              label="Employer Match"
              value={fmt(kpis.totalEmployerMatch)}
              sub="estimated annual match"
              icon={TrendingUp}
            />
            <KpiCard
              ...
              <CardContent>
                {isLoading ? (
                  ...
                  <div className="flex flex-col items-center justify-center gap-3 rounded-xl border border-dashed border-border py-12 text-center">
                    ...
                    <p className="text-sm text-muted-foreground">
                      No retirement accounts yet. Add your first to get started.
                    </p>
