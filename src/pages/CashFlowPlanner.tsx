      ...
      <SubscriptionGate tier="elite">
          ...
          >
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Track income, expenses, and project your financial runway
              </p>
            </div>
              ...
              <CardContent className="p-0">
                {isLoading ? (
                  ...
                  <div className="p-16 flex flex-col items-center gap-3 text-center">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Add your income sources and expenses to start planning.
                    </p>
                    <Button
                      onClick={openAdd}
                      variant="outline"
          ...
          {entries.length > 0 && (
            ...
            >
              <Card>
                <CardHeader className="pb-3">
                  <CardTitle className="text-base flex items-center gap-2">
                    <CalendarDays className="h-4 w-4" /> 12-Month Cash Flow
                    Projection
                  </CardTitle>
                </CardHeader>
                <CardContent className="p-0">
                      ...
                      <TableBody>
                        {projection.map((row) => (
                          <TableRow key={row.label}>
                            ...
                            <TableCell
                              className={`text-right font-semibold text-sm ${row.net >= 0 ? "text-primary" : "text-red-500"}`}
                            >
                              {fmt(row.net)}
                            </TableCell>
                            <TableCell
                              className={`text-right font-semibold text-sm ${row.cumulative >= 0 ? "text-primary" : "text-red-500"}`}
                            >
                              {fmt(row.cumulative)}
                            </TableCell>
                          </TableRow>
        ...
        >
          <DialogContent className="max-w-md">
            <DialogHeader>
              <DialogTitle>
                {editingEntry ? "Edit Entry" : "Add Cash Flow Entry"}
              </DialogTitle>
            </DialogHeader>
                ...
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setForm((f) => ({
                        ...f,
                        month_offset: parseInt(e.target.value) || 0,
                      }))
                    }
                  />
                </div>
        ...
        >
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                This will permanently remove this cash flow entry. This action
                cannot be undone.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
