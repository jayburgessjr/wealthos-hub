...
function computeWeightedAvgRate(debts: Debt[]): number {
  ...
  return (
    debts.reduce((s, d) => s + d.interest_rate * d.balance, 0) / totalBalance
  );
}
          ...
          {results.map((r) => (
            ...
            >
              ...
              <span className="text-muted-foreground tabular-nums">
                {r.months} mo ·{" "}
                <span className="text-bearish">{fmtDec(r.totalInterest)}</span>
              </span>
            </li>
          ))}
        </ol>
...
export default function DebtManager() {
  ...
  const avalanche = useMemo(
    () => computePayoffSchedule(debts, "avalanche"),
    [debts],
  );
  const snowball = useMemo(
    () => computePayoffSchedule(debts, "snowball"),
    [debts],
  );
      ...
      <SubscriptionGate tier="elite">
        <div className="space-y-6">
          ...
          >
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-0.5">
                Track balances, compare payoff strategies, and accelerate your
                debt-free date.
              </p>
            </div>
          ...
          >
            ...
            />
            <KpiCard
              label="Monthly Min Payment"
              value={fmt(kpis.totalMin)}
                ...
                {isLoading ? (
                  ...
                  <div className="flex flex-col items-center justify-center gap-3 rounded-xl border border-dashed border-border py-12 text-center">
                    ...
                    <p className="text-sm text-muted-foreground">
                      No debts tracked yet. Add your first debt to get started.
                    </p>
            ...
            >
              <div className="mb-3">
                ...
                <p className="text-xs text-muted-foreground mt-0.5">
                  Both strategies use your current min + extra payments.
                  Freed-up payments roll to the next debt.
                </p>
              </div>
