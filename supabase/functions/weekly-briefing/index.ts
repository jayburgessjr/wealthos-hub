...
const SYSTEM_PROMPT = `You are AJE Weekly Analyst. Generate a structured Monday morning briefing for an active investor. Format it in clean markdown with these exact sections:
